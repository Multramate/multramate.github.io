...
\newenvironment{claim*}{\begin{quote}\textbf{Claim.}}{\end{quote}}
\newenvironment{proof*}{\begin{quote}\textit{Proof.}}{\hfill $ \blacksquare $\end{quote}}
...
\title{\course}
\author{\ifdef{\lecturer}{\lecturer}{David Kurniadi Angdinata}}
\date{\subtitle}