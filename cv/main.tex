...
\cventry{09/21 -- 09/25}{PhD Mathematics}{London School of Geometry and Number Theory}{London}{}{Supervisors: Prof Vladimir Dokchitser and Prof Kevin Buzzard. \\ Research interests: algebraic number theory and arithmetic geometry.}
...
\cventry{10/21 -- $ \quad \ \quad $}{Department of Mathematics teaching assistant}{University College}{London}{}{Ran weekly group tutorials and drop-in revision sessions for mathematics courses in year 1 (algebra 2, analysis 2) and year 2 (further linear algebra, groups and rings, number theory), and assessment marking for mathematics courses in year 3 (Galois theory, logic).}
...
\cvline{02/23}{Symposium on Arithmetic Geometry and its Applications, Cirm}
\cvline{01/23 -- 02/23}{Introduction to Symposium on Arithmetic Geometry and its Applications, Cirm}
\cvline{12/22}{Advent of Rational Points, King's College}
\cvline{10/22 -- 11/22}{Preliminary Arizona Winter School 2022: Heights and Model Theory, Online}
\cvline{08/22}{Young Researchers in Algebraic Number Theory, University of Glasgow}
\cvline{08/22}{Mordell 2022, Cambridge}
\cvline{08/22}{Elliptic Curves 2022, Baskerville Hall}
\cvline{06/22}{73rd British Mathematical Colloquium, King's College}
