...
data P7 = P7 deriving (Enum, Show)
instance Prime P7

data P11 = P11 deriving (Enum, Show)
instance Prime P11

data P13 = P13 deriving (Enum, Show)
instance Prime P13

data P17 = P17 deriving (Enum, Show)
instance Prime P17

data P31 = P31 deriving (Enum, Show)
instance Prime P31

eFp :: EC (Fp P31)
eFp = throw $ sW (-5) (0)
-- eFp = throw $ lW 0 (-1) 0 (-17^2) (17^2)

eQ :: EC Q
eQ = throw $ sW (0) (1)
-- eQ = throw $ lW 0 (-1) 0 (-17^2) (17^2)
